...
OMPI_DECLSPEC int32_t ompi_datatype_create_vector( size_t count, size_t bLength, size_t stride,
                                                   const ompi_datatype_t* oldType, ompi_datatype_t** newType );
OMPI_DECLSPEC int32_t ompi_datatype_create_hvector( size_t count, int bLength, ptrdiff_t stride,
                                                    const ompi_datatype_t* oldType, ompi_datatype_t** newType );
OMPI_DECLSPEC int32_t ompi_datatype_create_indexed( size_t count, const size_t* pBlockLength, const size_t* pDisp,
                                                    const ompi_datatype_t* oldType, ompi_datatype_t** newType );
