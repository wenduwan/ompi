                                       ...
                                       mca_coll_base_module_t *module)
{
    ...
    sub_module = get_module(GATHERV, 0, comm, han_module);
    ...
    if(NULL == sub_module) {
         ...
         * Call han topological collective algorithm
         */
        int algorithm_id = get_algorithm(GATHERV, 0, comm, han_module);
    ...
    return gatherv(sbuf, scount, sdtype, rbuf, rcounts, displs, rdtype, root, comm, module);
}
